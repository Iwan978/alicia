...
/**
 * Optional dependency for better color support.
 */
let supportsColor;
try {
...
// Only extend the `util.inspect` options if colors are enabled
if (useColors()) {
...
// Only apply the color support if `supports-color` is available
