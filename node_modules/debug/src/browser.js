...
function save(namespaces) {
	if (namespaces && typeof localStorage !== 'undefined' && localStorage.enabled) {
...
function load() {
	let r;
	if (typeof localStorage !== 'undefined' && localStorage.enabled) {
...
module.exports = require('./common')(debug);
